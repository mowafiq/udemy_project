      ...
      children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage("images/php-course.jpg"),
                    colorFilter: ColorFilter.mode(
                        Color.fromARGB(115, 0, 0, 0), BlendMode.hardLight),
                    fit: BoxFit.cover)),
          ),
          Column(
            children: [
              ...
              Padding(
                ...
                child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor: Color.fromARGB(255, 176, 31, 161),
        ...
        Expanded(
          ...
          ListView.builder(
            ...
            itemCount: aalist.length,
            itemBuilder: (context, index) {
              return ListTile(
                onTap: () {
                  setState(() {
                    selectedIndex = index;
                    _lecnamee(aalist[index].lecname);
                    _lecnum("Lecture " + (aalist[index].num.toString()));
                  });
                },
                title: Text(
                  aalist[index].lecname,
                  style: TextStyle(
                      fontSize: selectedIndex == index ? 17 : 16,
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              return ListTile(
                  onTap: () {},
                  title: Text(bblist[index].nn),
                  leading: bblist[index].a);
            },
          )
        ]))
      ],
